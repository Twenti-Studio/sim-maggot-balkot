<x-layouts.app title="Laporan & Export" subtitle="Unduh laporan operasional PDF dan Excel">
    ...
    <div class="grid gap-5 sm:grid-cols-2">@foreach([
        ...
        'attendance'=>['Absensi petugas','Check-in, check-out, dan status kehadiran.','clock'],
